...
<script type="text/javascript">
    ...
    function changer(clickedId)
    {
       if(clickedId == "1"){
         document.getElementById("compte_ex").style.display = "";
         document.getElementById("compte_non_ex").style.display = "none";
       }else{
    	   document.getElementById("compte_ex").style.display = "none";
         document.getElementById("compte_non_ex").style.display = "";
       }
    }
    ...
    function changer_client(clickedId)
    {
       if(clickedId == "1"){
         document.getElementById("client_ex").style.display = "";
         document.getElementById("client_non_ex").style.display = "none";
       }else{
    	   document.getElementById("client_ex").style.display = "none";
         document.getElementById("client_non_ex").style.display = "";
       }
    }
  </script>
        ...
        <div class="col-md-12">
            <div class="card card-user">
              <div class="card-header">
                <h5 class="card-title">Associer les Comptes aux clients</h5>
                <br>
                 <div class="row">
               <h5 style="color:red">${errorEx}</h5>
               </div>
              </div>
               </div>
                </div>
            ...
            <div class="card card-user">
              ...
              <div class="row">
                ...
                <h5 class="card-title">Comptes</h5>
                    ...
                    <div class="col-md-6 pr-1">
                                <form action="AssocierCompteBnq" method="post"> 
                  <div class="form-group">
                        <label>Compte :</label>
                         <select class="form-control" name="compte" onchange="changer(this.value)">
              ...
              <div id="compte_ex"  style="display:none">
             <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Comptes :</label>
                         <select class="form-control" name="compte_id">
                          ...
                          <option value='<c:out value="${compte.getId()}"></c:out>'>${compte.getCode()}</option>
                          </c:forEach>
              ...
              <div id="compte_non_ex">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        <label>Solde :</label>
                        <input type="text" name="solde"  class="form-control" placeholder="solde" value="">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 ">
                            ...
                            <div class="col-md-2 ">
                      <div class="form-group">
                         <input type ="radio" class="form-control" name="type" value="1" onchange="changerType(this.value)">
                      </div>
                      </div>
                      <div class="col-md-8 ">
                              <div class="form-group">
